...
class MainFrame extends JFrame implements ActionListener,MouseListener,Runnable
{
    ...
    MainFrame()
    {
    	...
    	con.add(chessBoard=new JLabel(new ImageIcon("ÆåÅÌ.png")));
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		if(e.getSource().equals(chessBoard))
		{
			if(flag==2&&chessPieces[respose].getName().charAt(1)=='2')
			{
				...
				{
					rule.cannonRule(chessPieces[respose],chessPieces,e,vec,respose);
				}
				...
				{
					rule.horseRule(chessPieces[respose],chessPieces,e,vec,respose);
				}
				else if(respose>7&&respose<12)
				{
					rule.elephantRule(respose,chessPieces[respose],chessPieces,e,vec);
				}
				else if(respose>11&&respose<16)
				{
					rule.chapRule(respose,chessPieces[respose],chessPieces,e,vec);
				}
				else if(respose==30||respose==31)
				{
					rule.willRule(respose,chessPieces[respose],chessPieces,e,vec);
				}
				...
				for(i=0;i<32;i++)
				{
					if(e.getSource().equals(chessPieces[i]))
					{
						if(flag==2&&chessPieces[respose].getName().charAt(1)=='2')
						{
							...
							if(respose>15&&respose<26)
							{
								rule.armsRule(chessPieces[respose],chessPieces[i],vec,respose,i);
							}
							else if(respose>25&&respose<30)
							{
								rule.cannonRule(0,i,chessPieces[respose],chessPieces[i],chessPieces,vec,respose,e);
							}
							else if(respose>=0&&respose<4)
							{
								rule.cannonRule(1,i,chessPieces[respose],chessPieces[i],chessPieces,vec,respose,e);
							}
							else if(respose>3&&respose<8)
							{
								rule.horseRule(chessPieces[respose],chessPieces[i],chessPieces,e,vec,respose,i);
							}
							else if(respose>7&&respose<12)
							{
								rule.elephantRule(chessPieces[respose],chessPieces[i],chessPieces,vec,respose,i);
							}
							else if(respose>11&&respose<16)
							{
								rule.chapRule(respose,chessPieces[respose],chessPieces[i],chessPieces,vec,i);
							}
							else if(respose==30||respose==31)
							{
